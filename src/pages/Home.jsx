...
const qilipingImages = [
  { src: '/sygo/images/campus/gate-east.jpg', caption: '东门（超越门）' },
  { src: '/sygo/images/campus/gate-north1.jpg', caption: '北一门' },
  { src: '/sygo/images/campus/gate-north2.jpg', caption: '北二门' },
  { src: '/sygo/images/campus/gate-north3.jpg', caption: '北三门' },
  { src: '/sygo/images/campus/library.jpg', caption: '图书馆' },
  { src: '/sygo/images/campus/teaching-building.jpg', caption: '教学楼' },
];

// 李子园校区实拍
const liziyuanImages = [
  { src: '/sygo/images/campus/liziyuan-gate.jpg', caption: '李子园校门' },
  { src: '/sygo/images/campus/liziyuan-library.jpg', caption: '李子园图书馆' },
  { src: '/sygo/images/campus/liziyuan-office.jpg', caption: '李子园办公楼' },
];
