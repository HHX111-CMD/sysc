...
// 宿舍实拍图片
const dormImages = [
  { src: '/sygo/images/dorm/leshan.jpg', caption: '乐山公寓' },
  { src: '/sygo/images/dorm/caiqin.jpg', caption: '采芹公寓' },
  { src: '/sygo/images/dorm/xinglin.jpg', caption: '杏林公寓' },
  { src: '/sygo/images/dorm/panyong.jpg', caption: '泮水公寓' },
];

// 食堂实拍图片
const canteenImages = [
  { src: '/sygo/images/canteen/liuxiang.jpg', caption: '留香食堂' },
  { src: '/sygo/images/canteen/yixiang.jpg', caption: '溢香食堂' },
  { src: '/sygo/images/canteen/xinxiang.jpg', caption: '馨香食堂' },
  { src: '/sygo/images/canteen/xingxiang.jpg', caption: '杏香食堂' },
];
